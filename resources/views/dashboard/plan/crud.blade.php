                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        @foreach($plans as $key=>$plan)
                            <tr>
                                <th scope="row">{{ ++$key }}</th>
                                <td><img src="{{ $plan->photo }}" alt="" style="height: 100px; width: 100px"></td>
                                <td class="text-center">
                                    <button class="btn btn-xs btn-success" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalCenter{{ $plan->id }}Edit"><i class="bx bx-pencil"></i></button>
                                    <div class="modal fade" id="exampleModalCenter{{ $plan->id }}Edit" tabindex="-1" aria-labelledby="exampleModalCenter" aria-hidden="true">
                                                                ...
                                                                <div class="col-6">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="col-12 text-center">
                                                                            ...
                                                                            <img style="height: 100px; width: 100px" src="{{ $plan->photo }}">
                                                                        </div>
